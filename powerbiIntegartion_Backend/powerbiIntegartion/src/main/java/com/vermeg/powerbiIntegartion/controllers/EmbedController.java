...
package com.vermeg.powerbiIntegartion.controllers;

import com.vermeg.powerbiIntegartion.config.Config;
import com.vermeg.powerbiIntegartion.models.EmbedConfig;
import com.vermeg.powerbiIntegartion.models.ReportConfig;
import com.vermeg.powerbiIntegartion.services.AzureADService;
import com.vermeg.powerbiIntegartion.services.PowerBIService;
...
public class EmbedController {
	...
	public ResponseEntity<String> embedInfoController() throws JsonMappingException, JsonProcessingException {
		...
		try {
			...
			responseObj.put("reportId", Config.reportId); // Ajoutez l'ID du rapport ici
